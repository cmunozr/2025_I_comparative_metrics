  ...
  if(run_new_var_XData){
    ...
    if (length(conflicting_targets) > 0) {
      ...
      if(length(unique_vars_to_process) == 0){
        ...
        stop("There is no additional variable to add in XData, skipping. Check associated variables dictionary or if you want to re-run all covariates use run_calculate_XData = T.")
      }
