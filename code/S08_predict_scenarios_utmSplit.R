...
#'
#' SYSTEM REQUIREMENTS:
#' - CPU: High core count recommended (configured for 20 cores).
#' - RAM: Heavy usage during prediction; ~32GB+ recommended for 4000-site batches.
#' - Disk: Fast I/O (SSD) preferred for writing multi-gigabit Parquet partitions.
